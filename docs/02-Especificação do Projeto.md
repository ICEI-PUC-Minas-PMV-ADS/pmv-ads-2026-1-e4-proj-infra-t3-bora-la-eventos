...
|RF-008|Permitir a inserção e edição de comentários nas páginas de eventos|BAIXA|*A definir* |
...
|RF-013| Permitir que os usuários se registrem e gerenciem seus perfis | BAIXA| *A definir* |
